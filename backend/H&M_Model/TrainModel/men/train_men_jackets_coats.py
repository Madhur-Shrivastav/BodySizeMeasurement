...
def dump_model(model,style_encoder, category_encoder, size_encoder, scaler):
    category_name = "jackets_coats"     
    ...
    joblib.dump(style_encoder, f"../../Encoders/men/{category_name}_style_encoder.pkl")
...
df = pd.read_csv("../../Datasets/men/jackets_coats_data.csv")
...
dump_model(model,style_encoder,category_encoder,size_encoder,scaler)
